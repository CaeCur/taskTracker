...
function get_project_list()
{
    ...
    try {
        ...
        echo "connection failed for get project list: "
            . $e->getMessage()
            . "<br>";
...
function add_project($title, $category, $project_id = null)
{
    ...
    try {
        ...
        echo "Error on add_project: " . $e->getMessage() . "<br>";
        return false;
    }
...
function delete_project($project_id)
{
    ...
    try {
        ...
        echo "Error on get_task: " . $e->getMessage() . "<br>";
        return false;
    }
...
function get_project($project_id)
{
    ...
    try {
        ...
        echo "Error on get_project: " . $e->getMessage() . "<br>";
        return false;
    }
...
function add_task($project_id, $title, $date, $time, $task_id = null)
{
    ...
    try {
        ...
        echo "Error on add_task: " . $e->getMessage() . "<br>";
        return false;
    }
